...
\end{frame}
\begin{frame}{Sheet 5}
	10. We can compute the volume of the portion cut out by finding the area of revolution (about the $y-$axis) of the shaded part. This can be done easily using washer method.\\
